                        ...
                        <div class="feature text-center">
                            <div class="icon mb-3">
                                <img src="{{ $service->icon ? asset('storage/icons/' . $service->icon) : asset('images/icon-placeholder.svg') }}"
                                    alt="{{ $service->title }}" class="img-fluid" style="height: 50px;" loading="lazy">
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    ...
                    <p class="mb-4">High-quality materials and craftsmanship ensure a premium experience for your home.
                    </p>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <a class="product-item" href="{{ route('shop.show', $furniture->id) }}">
                            <img src="{{ $furniture->image ? asset('storage/' . $furniture->image) : asset('images/product-placeholder.png') }}"
                                class="img-fluid product-thumbnail" alt="{{ $furniture->name }}">
